...
namespace WHM
{
    ...
    //Link to the .NET Connector (.dll file) http://dev.mysql.com/downloads/connector/net/
    {
        ...
        public MySqlConnection DBConnection { get { return conn; } }
        ...
        public Database(string hostname, string database, string username, string password, int portNumber)
        {
            conn = new MySqlConnection("host=" + hostname + ";database=" + database + ";username=" + username + ";password=" + password + ";port=" + portNumber.ToString() +";");
        }

        public Database(string hostname, string database, string username, string password, int portNumber, int connectionTimeout)
        {
        ...
        public MySql.Data.MySqlClient.MySqlDataReader  getStore(string store) 
        {
